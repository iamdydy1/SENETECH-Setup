...
# Backward-compatible rescue patch for cached build-22 manifests.
...
# Ensure Reporter integration exists when the actual engine is still build 17.
...
# Ensure Reporter UI integration exists.
...
# Ensure channel-aware updater is used.
...
# Normalize ALL mixed version markers so title/header/engine cannot disagree.
foreach ($candidate in 17..22) {
