...
# Apply previous V1.6.0.6 patch first.
$previousPatch = Join-Path $env:TEMP 'SENETECH-PATCH-1.6.0-v8.ps1'
$previousPatchUrl = 'https://raw.githubusercontent.com/iamdydy1/SENETECH-Setup/develop/src/PATCH-SENETECH-1.6.0-v8.ps1'
try {
...
$engineText = $engineText.Replace("`$script:AppVersion = '1.6.0.6'", "`$script:AppVersion = '1.6.0.7'")
...
if (Test-Path -LiteralPath $manifestPath) {
    ...
    $manifestText = $manifestText.Replace('version="1.6.0.6"','version="1.6.0.7"')
...
Correctif : reutilisation et reenregistrement de App Installer deja present quand WinGet est introuvable
'@

Write-Output 'SENETECH V1.6.0 DEV build 7 - correction App Installer/WinGet appliquee.'
