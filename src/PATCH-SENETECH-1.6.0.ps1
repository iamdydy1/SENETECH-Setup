...
$s = Replace-Required $s "$names = @('BrandLogo','StatusBadge','PcText','CpuText','RamText','GpuText','WindowsText','InternetText','ProfileCombo'," "$names = @('BrandLogo','StatusBadge','PcText','CpuText','RamText','GpuText','WindowsText','InternetText','ProfileCombo','LeftPanel','AppsPanel'," 'NamedControls'
