...
# Apply previous V1.6.0.3 patch first.
$previousPatch = Join-Path $env:TEMP 'SENETECH-PATCH-1.6.0-v5.ps1'
$previousPatchUrl = 'https://raw.githubusercontent.com/iamdydy1/SENETECH-Setup/develop/src/PATCH-SENETECH-1.6.0-v5.ps1'
try {
...
$engineText = $engineText.Replace("`$script:AppVersion = '1.6.0.3'", "`$script:AppVersion = '1.6.0.4'")
...
if (Test-Path -LiteralPath $manifestPath) {
    ...
    $manifestText = $manifestText.Replace('version="1.6.0.3"', 'version="1.6.0.4"')
...
Correctif : relance automatique apres mise a jour, y compris en mode Portable
'@

Write-Output 'SENETECH V1.6.0 DEV build 4 - correctif relance portable applique.'
